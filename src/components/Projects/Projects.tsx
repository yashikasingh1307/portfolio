          ...
          <div className="projects__grid">
            <article className="project">
              ...
              <div className="project__body">
                ...
                <p className="project__text">
                  ...
                  information using NLP and classification techniques. Achieved
                  78.13% accuracy and 73.13% F1-score, outperforming classical
                  ML baselines including Random Forest and Logistic Regression.
                </p>

                <p className="project__tech label">
                  Python · Machine Learning · NLP · DistilBERT · SHAP
                </p>
            ...
            <article className="project">
              ...
              <div className="project__body">
                ...
                <p className="project__text">
                  Android application designed to connect food donors, NGOs,
                  and people in need. It supports food listings, donation
                  workflows, and location-based connections to help make
                  surplus food easier to distribute.
                </p>
            ...
            <article className="project">
              ...
              <div className="project__body">
                ...
                <p className="project__text">
                  ...
                  food through an interactive experience. It combines curated
                  information with AI-powered recommendations to help users
                  discover places based on their interests.
                </p>
